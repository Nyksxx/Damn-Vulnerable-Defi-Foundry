...
import {TheRewarderAttack} from "../../../src/AttackContracts/TheRewarderAttack.sol";
...
contract TheRewarder is Test {
    ...
    TheRewarderAttack attackContract; // <<<<<<<---------- attack contract
    ...
    function testExploit() public {
        ...
        // deployin attack contract //

        attackContract = new TheRewarderAttack(address(flashLoanerPool), address(dvt),address(theRewarderPool),attacker);
        ...
        attackContract.attack(TOKENS_IN_LENDER_POOL);
